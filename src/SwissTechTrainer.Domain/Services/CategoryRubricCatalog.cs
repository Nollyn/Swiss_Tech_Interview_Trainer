...
public static class CategoryRubricCatalog
{
    ...
    {
        CategoryType.CleanCode => new List<RubricDefinition>
        {
        ...
        CategoryType.Coding => new List<RubricDefinition>
        {
        ...
        CategoryType.SystemDesign => new List<RubricDefinition>
        {
        ...
        CategoryType.DotNetDeepDive => new List<RubricDefinition>
        {
        ...
        CategoryType.ApiDesign => new List<RubricDefinition>
        {
        ...
        CategoryType.Testing => new List<RubricDefinition>
        {
        ...
        CategoryType.Behavioral => new List<RubricDefinition>
        {
